...
namespace F4SharedMem.Win32
{
    internal static class NativeMethods
    {
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern IntPtr MapViewOfFile(IntPtr hFileMappingObject, uint dwDesiredAccess, uint dwFileOffsetHight, uint dwFileOffsetLow, IntPtr dwNumberOfByteToMap);
        ...
        public static extern int VirtualQuery(ref IntPtr lpAddress, ref MEMORY_BASIC_INFORMATION lpBuffer, IntPtr dwLength);
